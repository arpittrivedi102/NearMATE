...
public class MessageService extends Service implements SinchClientListener {
	...
	private static final String APP_KEY = "9d5f49c3-53f2-4080-b53e-4c0f75850709";
	private static final String APP_SECRET = "pjlTHeaH0kKcdNz9IzdNgA==";
	private static final String ENVIRONMENT = "sandbox.sinch.com";

   

   public static final String INTENT_EXTRA_USERNAME = "intent";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
    	...
    	Log.e(TAG + "intent value", username);
