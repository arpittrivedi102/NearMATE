...
public class NearByTest extends Fragment  {
	...
	public void setUserVisibleHint(boolean isVisibleToUser) {
	    ...
	    if (isVisibleToUser) {
	    	...
	    	FetchingcurrentAddress obj_fetch = new FetchingcurrentAddress();
	...
	private static long getDistanceMeters(double lat1, double lng1, double lat2, double lng2) {
	   ...
	   /**
		...
		private class FetchingcurrentAddress extends AsyncTask<Void, Void, String> {
						          ...
						          // Log.e(TAG,"@@@@Retrieved " + objects.size());
						           for(int i=0;i<objects.size();i++)
						           {
							             try {
											...
											//searched_user_latitude.addAll(i, objects.get(i).getString("Lattitude"));
											//searched_user_longitude.add(i, objects.get(i).getString("Longitude"));
